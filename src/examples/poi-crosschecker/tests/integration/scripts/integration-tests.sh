...
docker compose run -d -e TEST_TOPIC="QmacQnSgia4iDPWHpeY6aWxesRFdb8o5DKZUx96zZqEWrB" -e TEST_ENVIRONMENT=true -e REGISTRY_SUBGRAPH="http://host.docker.internal:8031/mock-registry-subgraph" --name real-indexer indexer-1 
