...
# Contributing to the Gossip Client POC

Welcome to the Gossip Client POC! Thanks a ton for your interest in contributing.
...
Join the conversation on [the Graph Discord](https://discord.gg/9a5VCua).

Please follow the [Code of Conduct](https://github.com/graphops/gossip-client-poc/blob/main/CODE_OF_CONDUCT.md) for all the communications and at events. Thank you!
